...
I focus on **end-to-end AI pipelines**: dataset curation, model architecture, training, evaluation, optimization, and deployment behind clean REST APIs. Every project I build is designed to work in the real world — fast, accurate, and maintainable.
...
<div align="left">
  ...
  <img width="12"/>
  <img src="https://icon.icepanel.io/Technology/svg/GitHub-Actions.svg" height="45"/>
  <img width="12"/>
...
### 🦯 Virtual Eye — AI Accessibility App for the Visually Impaired
...
- [📂 View Repository](https://github.com/YOUR_USERNAME/Artificial-Intelligence-Labs)
...
<h3 align="center">🔬 Train. Deploy. Iterate. Build AI That Works.</h3>
